...
public class TestingRunnerImpl implements TestingRunner {
    ...
    public TestingRunnerImpl(QuestionService service, InputOutputService inputOutputService, ResultService resultService, MessageService messageService) {
    ...
    @Override
    public void runTesting(Student student) {
        inputOutputService.output(messageService.getMessage("hello", student.toString()));
